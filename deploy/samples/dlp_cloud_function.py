...
PROJECT_ID = os.environ['PROJECT_ID_HOSTING_STAGING_BUCKET']
"""The bucket the to-be-scanned files are uploaded to."""
STAGING_BUCKET = os.environ['YOUR_QUARANTINE_BUCKET']
"""The bucket to move "sensitive" files to."""
SENSITIVE_BUCKET = os.environ['YOUR_SENSITIVE_DATA_BUCKET']
"""The bucket to move "non sensitive" files to."""
NONSENSITIVE_BUCKET = os.environ['YOUR_NON_SENSITIVE_DATA_BUCKET']
